...
$sql = mysqli_query($koneksi, "SELECT * FROM db_kas");
...
?>
    ...
    <marquee behavior="" direction="" style="font-size: 19px; color: maroon;">Selamat Datang Di Sistem Informasi Aplikasi Pengelolaan Kas  </marquee>
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1>DASHBOARD KAS</h1>
